// src/screens/PastSchedulingsScreen.tsx
        ...
        <Pressable style={styles.overlay} onPress={() => setSelected(null)}>
          <Pressable style={styles.modal} onPress={() => { }}>
            <ScrollView>
              ...
              <TouchableOpacity style={[styles.modalBtn, { backgroundColor: COLORS.errorLight }]} onPress={remove}>
...
const styles = StyleSheet.create({
  ...
  row: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, borderBottomWidth: 0.5, borderBottomColor: COLORS.light, gap: 10 },
  name: { color: COLORS.primary, fontFamily: 'times', fontWeight: '700' },
  meta: { color: COLORS.placeholder, fontFamily: 'times', fontWeight: '700', marginTop: 2 },
  menu: { width: 42, height: 42, borderRadius: 10, backgroundColor: COLORS.primaryBg, alignItems: 'center', justifyContent: 'center' },
  ...
  modal: { width: '94%', maxHeight: '85%', backgroundColor: COLORS.card, borderRadius: 18, padding: 16 },
  ...
  modalBtn: { borderRadius: 12, paddingVertical: 12, alignItems: 'center', marginTop: 10 },
